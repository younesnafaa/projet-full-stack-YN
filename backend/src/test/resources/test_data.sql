-- Contenu initial chargé avant tous les tests. Ne doit pas être vide
...
VALUES (default, 'Projet 1 (en cours)', '2025-01-01', NULL),        -- code 1
       ...
       (default, 'Projet 4 (en cours, aucune participation)', '2024-11-01', NULL); -- code 4
...
VALUES ('Chef de projet', 0.2, 1, 2),       -- participation 1
       ...
       ('Back-End developper', 0.2, 3, 4),  -- participation 11
       ('Front-End developper', 0.3, 4, 3); -- participation 12
